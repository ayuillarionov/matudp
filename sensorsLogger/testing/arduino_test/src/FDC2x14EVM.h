...
/*===============================================================================*/
/* Sellecting the Serial port Number on MAC OSX                                  */
/* ------------------------------------------------------------------------------*/
/* /dev/tty.KeySerialx                                                           */
/*===============================================================================*/
...
#define RECV_SIZE     32 // it is always 32 bytes (ASCII) response, which is
...
static const unsigned output_gain = 1;
...
static const char rr_sequence[3] = "01"; // Auto-Scan Sequence Configuration (10 -- Ch0-Ch3)
