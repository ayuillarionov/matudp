...
<<<<<<< HEAD
// remove the warning: ISO C forbids an empty translation unit [-Wpedantic]
=======
// gcc when compiled with -pedantic reports a diagnostic when the translation unit is empty
// as it is requested by the C Standard
>>>>>>> 687c94be6cf05a591cd01fa0ce67fc7ab84813d2
